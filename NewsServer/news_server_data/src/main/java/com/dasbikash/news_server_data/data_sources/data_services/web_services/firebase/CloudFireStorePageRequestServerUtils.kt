...
//            throw IllegalArgumentException()
        ...
        }while (!writeTask.isComplete || deleteTasks.map { !it.isComplete() }.count()>0)
    }
...
internal data class PageDownLoadRequestResponse(
    ...
    override fun toString(): String {
        return "PageDownLoadRequestResponse(link=$link, pageContent=${pageContent?.length ?: 0}, created=${created?.toDate()})"
    }
}