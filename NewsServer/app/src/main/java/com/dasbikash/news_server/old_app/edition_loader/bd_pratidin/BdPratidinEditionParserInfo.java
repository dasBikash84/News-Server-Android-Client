...
class BdPratidinEditionParserInfo {

    static final String ARTICLE_PREVIEW_BLOCK_SELECTOR = ".normal-news-sum";
    ...
    static final String ARTICLE_TITLE_ELEMENT_SELECTOR = "h1";
}
