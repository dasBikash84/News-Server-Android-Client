...
class DoinickIttefaqEditionParserInfo {

    static final String ARTICLE_PREVIEW_BLOCK_SELECTOR = ".allnews";
    ...
    static final String ARTICLE_PUBLICATION_DATE_TIME_FORMAT = "HH:mm, dd MMM, yyyy";
}
