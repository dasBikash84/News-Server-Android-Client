...
class FragmentNPStatusChangeRequest : Fragment() {
    companion object {
        ...
        private val REQUEST_SUBMISSION_SUCCESS_MESSAGE = "News paper status change request submitted."
        private val REQUEST_SUBMISSION_FAILURE_MESSAGE = "News paper status change request submission failure."
